...
EMAIL_REGEX: Fianl[str] = r"""(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|"(?:[
...
class Browser:
    ...
    # Initialize the webdriver with path to chromedriver.exe
...
def main():
    ...
    # Scrape the e-mails
    emails: set = browser.scrape_emails(url='https://www.google.com')
